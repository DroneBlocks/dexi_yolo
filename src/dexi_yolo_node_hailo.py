...
class DexiYoloHailoNode(Node):
    ...
    def __init__(self):
        ...
        # Parameters
        self.declare_parameter('hef_path', '/usr/share/hailo-models/yolov8s_h8l.hef')
    ...
    def _parse_detections(self, raw_output, original_shape):
        """Parse Hailo NMS output — list of 80 arrays, each (N_i, 5) per class"""
        detections = []
        ...
        for cls_idx, class_dets in enumerate(raw_output):
            ...
            for det_idx in range(arr.shape[0]):
                ...
                # Hailo NMS outputs normalized coords [y_min, x_min, y_max, x_max, score]
